...
class DistributedSamplerWrapper(DistributedSampler):
    """Wrapper to use a non-distributed sampler with DistributedDataParallel.
    Replaces catalyst.data.sampler.DistributedSamplerWrapper to avoid
    catalyst/hydra/omegaconf version conflicts.
    """

    def __init__(self, sampler, **kwargs):
        super().__init__(dataset=sampler, **kwargs)
