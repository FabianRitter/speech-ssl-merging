...
# Monkey patch collections to include MutableMapping for legacy support
...
def get_downstream_args():
    ...
    parser.add_argument('--sheet_name', type=str, default='SLLM_encoder_eval', help='Google Sheet spreadsheet name')
    parser.add_argument('--worksheet_name', type=str, default='dowstream-performance-distilled-models', help='Google Sheet worksheet name')
    parser.add_argument('--worksheet_logfile_name', type=str, default='Dowstream-performance-distilled-models-logfiles', help='Google Sheet logfile worksheet name')
    ...
    parser.add_argument('--early_stopping_patience', type=int, default=15,
                        help='Stop if no dev improvement for N eval cycles. 0=disable.')
    ...
    if args.past_exp:
        ...
        cannot_overwrite_args = [
            ...
            'device',
            'current_row_downstream', 'logfile_row_downstream',
            'current_row', 'update_results', 'json_file',
            'logfile',
        ]
