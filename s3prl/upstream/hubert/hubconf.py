...
def hubert_base_robust_mgwham_rbp(refresh=False, legacy=True, *args, **kwargs):
    """
    ...
    Distortions include Musan, Gaussian, WHAM, reverb, bandrej, pitch shift.
        refresh (bool): whether to download ckpt/config again if existed
        legacy (bool): use fairseq-based loading (default True, checkpoint is fairseq format)
    """
    ...
    return hubert_custom(refresh=refresh, legacy=legacy, *args, **kwargs)
